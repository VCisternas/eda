...
Five Point Summary for: Teilnehmer
```{r}
summary(data$Teilnehmer)

```
Five Point Summary for: Geschlecht
```{r}
summary(data$Geschlecht)

```
Five Point Summary for: Groesse
```{r}
summary(data$Groesse)

```
Five Point Summary for: Schuhgroesse
```{r}
summary(data$Schuhgroesse)

```
Five Point Summary for: Haarfarbe
```{r}
summary(data$Haarfarbe)

```
Five Point Summary for: Musikalitaet
```{r}
summary(data$Musikalitaet)

```
Five Point Summary for: Mathe
```{r}
summary(data$Mathe)

```
Five Point Summary for: WhatsApp
```{r}
summary(data$WhatsApp)

```
Five Point Summary for: AnzSchuhe
```{r}
summary(data$AnzSchuhe)

```
Five Point Summary for: Fussballfan
```{r}
summary(data$Fussballfan)
