...
difference <- data.frame(
  'Text Messagers' =  df[df$Group=="Text Messagers","Six_months"] - df[df$Group=="Text Messagers","Baseline"],
  'Controls' = df[df$Group=="Controls","Six_months"] - df[df$Group=="Controls","Baseline"]
                         )
boxplot(difference, ylab="Änderung des Ergebnis in %")
