...
scatterplot3d(threeD.df, type = 'h', highlight.3d = TRUE, angle= 30)
```
...
```
Interpretation: 
Auf dem Korrepationsplot ist zu erkennen, dass eine starke Korrelation (r~0,8) zwischen der Schuhgroesse und der Groesse in den Daten besteht.
...
```
Inerpretation:
Die überwiegend geraden Linien zwischen Groesse und Schuhgröße deuten auf eine positive Korrelation hin. Beispielsweise gehören Datenpunkte mit kleiner Größe und kleiner Schuhgröße zusammen.

Zwischen der Schuhgroesse und der Anzahl an Schuhen ist kein Zusammenhang zu erkennen. Die Linien erscheinen Zufällig.
